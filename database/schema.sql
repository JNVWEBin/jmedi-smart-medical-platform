...
CREATE TABLE IF NOT EXISTS doctor_schedules (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UNIQUE(doctor_id, day_of_week, session_label)
);
...
INSERT INTO hero_slides (title, subtitle, description, button_text, button_link, text_animation, transition_effect, sort_order, status) VALUES
